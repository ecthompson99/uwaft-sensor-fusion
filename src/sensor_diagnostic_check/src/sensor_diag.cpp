...
int main(int argc, char** argv) {
    ...
    ros::Publisher sensor_diag_pub = sensor_diag_handle.advertise<ecmc::sensor_diagnostic_flag_msg>(
        "sensor_diagnostic_flags", TX_RX_MESSAGE_BUFFER_SIZE);

    ecmc::sensor_diagnostic_flag_msg radar_msg;
