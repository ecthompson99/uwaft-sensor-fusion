...
class RadarObject {
    public:
        ...
        double set_w_obstacle, bool set_flag_valid, double set_w_non_obs, bool set_flag_meas,
        bool set_flag_hist, double set_length, double set_dz, double set_moving_state, double set_w_class,
        double set_obj_class, double set_rear_loss, uint8_t set_radar_num, double set_timestamp)
            : radar_dx(set_dx),
            radar_dy(set_dy),
            radar_vx(set_vx),
            radar_vy(set_vx),
