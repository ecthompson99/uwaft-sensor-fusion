...
void read_sensor_data_csv(string filename, vector<double>& time, vector<radar_data>& front_radar,
                          vector<radar_data>& right_radar, vector<radar_data>& left_radar,
                          vector<mobileye_data>& mobileye, vector<float>& veh_speed) {
...
int main(int argc, char** argv) {
  ...
  ros::NodeHandle nh;
  rosbag::Bag bag;
  bag.open("scenario5.bag", rosbag::bagmode::Write);
  ...
  simulation_file_path.append("/kaiROS/src/simulation_sensor_data/csv/scenario5.csv");
