classdef sudo_driver_input_msg < ros.Message
    %sudo_driver_input_msg MATLAB implementation of master_task/sudo_driver_input_msg
    ...
    properties (Constant)
        MessageType = 'master_task/sudo_driver_input_msg' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.master_task.sudo_driver_input_msg.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.master_task.sudo_driver_input_msg;
            obj.reload(strObj);
        end
    end
end
