classdef filtered_object_msg < ros.Message
    %filtered_object_msg MATLAB implementation of sensor_fusion/filtered_object_msg
    ...
    properties (Constant)
        MessageType = 'sensor_fusion/filtered_object_msg' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'd7f52c5a0f128bcc11854e949e2313d5' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Header', 'ObjAx', 'ObjCount', 'ObjDx', 'ObjDy', 'ObjId', 'ObjLane', 'ObjPath', 'ObjTimestamp', 'ObjVx', 'ObjVy'} % List of non-constant message properties
        ROSPropertyList = {'header', 'obj_ax', 'obj_count', 'obj_dx', 'obj_dy', 'obj_id', 'obj_lane', 'obj_path', 'obj_timestamp', 'obj_vx', 'obj_vy'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'filtered_object_msg', 'Header');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sensor_fusion.filtered_object_msg.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sensor_fusion.filtered_object_msg;
            obj.reload(strObj);
        end
    end
end
