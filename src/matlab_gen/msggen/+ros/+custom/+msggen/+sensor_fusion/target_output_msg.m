classdef target_output_msg < ros.Message
    %target_output_msg MATLAB implementation of sensor_fusion/target_output_msg
    ...
    properties (Constant)
        MessageType = 'sensor_fusion/target_output_msg' % The ROS message type
    end
    ...
    methods
        function obj = target_output_msg(msg)
            %target_output_msg Construct the message object target_output_msg
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'target_output_msg', 'Header');
        ...
        function set.ObjId(obj, objid)
            ...
            validateattributes(objid, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjId');
        ...
        function set.ObjDx(obj, objdx)
            ...
            validateattributes(objdx, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjDx');
        ...
        function set.ObjLane(obj, objlane)
            ...
            validateattributes(objlane, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjLane');
        ...
        function set.ObjVx(obj, objvx)
            ...
            validateattributes(objvx, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjVx');
        ...
        function set.ObjDy(obj, objdy)
            ...
            validateattributes(objdy, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjDy');
        ...
        function set.ObjAx(obj, objax)
            ...
            validateattributes(objax, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjAx');
        ...
        function set.ObjPath(obj, objpath)
            ...
            validateattributes(objpath, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjPath');
        ...
        function set.ObjVy(obj, objvy)
            ...
            validateattributes(objvy, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjVy');
        ...
        function set.ObjTimestamp(obj, objtimestamp)
            ...
            validateattributes(objtimestamp, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjTimestamp');
        ...
        function set.ObjTrackNum(obj, objtracknum)
            ...
            validateattributes(objtracknum, {'numeric'}, {'nonempty', 'scalar'}, 'target_output_msg', 'ObjTrackNum');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sensor_fusion.target_output_msg.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sensor_fusion.target_output_msg;
            obj.reload(strObj);
        end
    end
end
