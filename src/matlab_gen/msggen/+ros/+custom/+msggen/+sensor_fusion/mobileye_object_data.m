classdef mobileye_object_data < ros.Message
    %mobileye_object_data MATLAB implementation of sensor_fusion/mobileye_object_data
    ...
    properties (Constant)
        MessageType = 'sensor_fusion/mobileye_object_data' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = ros.custom.msggen.sensor_fusion.mobileye_object_data.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = ros.custom.msggen.sensor_fusion.mobileye_object_data;
            obj.reload(strObj);
        end
    end
end
