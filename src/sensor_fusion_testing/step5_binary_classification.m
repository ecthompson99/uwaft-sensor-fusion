ground_truth = load('C:\Users\Jillian\Documents\UWAFT\kaiROS\sensor fusion testing\KF_clustering_year1\ground_truth.mat');

bag = ('C:\Users\Jillian\Documents\UWAFT\kaiROS\sensor fusion testing\2020-04-27-00-44-09.bag');

temp = readMessages(bag, 'Topic', '/binary_class');

output = select(temp, 'DataFormat', 'struct');
...
THRESHOLD = 11; %used in year 1, may change
