...
int main(int argc, char **argv){
    ...
    ros::NodeHandle n;
    ros::ServiceServer server_ch2 = n.advertiseService("sensor_diagnostic_CH2", srv_ch2_callback, this);     
    ros::ServiceServer server_ch3 = n.advertiseService("sensor_diagnostic_CH3", srv_ch3_callback, this);     
    ros::ServiceServer server_ch4 = n.advertiseService("sensor_diagnostic_CH4", srv_ch4_callback, this);     
...
bool srv_ch2_callback(common::sensor_diagnostic_flag_CH2::Request &req, common::sensor_diagnostic_flag_CH2::Response &res){
    std::cout << "FRONT RADAR STATUS: " << req.frontradar << std::endl;
    return true;
}
