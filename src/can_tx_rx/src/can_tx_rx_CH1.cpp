...
void CAV_PCM_TX_RX::can_callback(const common::can_comms_data_msg& recvd_data){
    ...
    // std::cout << "\n\nComms input from master task --- ";
    // std::cout << "CAV out Long accel: " << cav_out.long_accel << std::endl;
    // std::cout << "CAV out LCC steer: " << cav_out.lcc_steer << std::endl;
    // std::cout << "CAV out ACC valid: " << cav_out.acc_valid << std::endl;
    // std::cout << "CAV out AEB valid: " << cav_out.aeb_valid << std::endl;
    // std::cout << "CAV out LCC valid: " << cav_out.lcc_valid << std::endl;
    // std::cout << "CAV out ACC fault: " << cav_out.acc_fault << std::endl;
    // std::cout << "CAV out AEB fault: " << cav_out.aeb_fault << std::endl;
    // std::cout << "CAV out LCC fault: " << cav_out.lcc_fault << std::endl;
    // std::cout << "CAV out FRadar fault: " << cav_out.front_radar_fault << std::endl;
    // std::cout << "CAV out LRadar fault: " << cav_out.left_radar_fault << std::endl;
    // std::cout << "CAV out RRadar fault: " << cav_out.right_radar_fault << std::endl;
    // std::cout << "CAV out Mobileye Fault: " << cav_out.mobileye_fault << std::endl;
    // std::cout << "CAV out CAV RC: " << cav_out.cav_rolling_counter << std::endl;
    // std::cout << "CAV out Lat PV: " << cav_out.lat_pv << std::endl;
    // std::cout << "CAV out Long PV: " << cav_out.long_pv << std::endl;
    // std::cout << "CAV out Lat RC: " << cav_out.lat_rc << std::endl;
    // std::cout << "CAV out Long RC: " << cav_out.long_rc << std::endl;
