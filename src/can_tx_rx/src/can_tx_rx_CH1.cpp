...
void CAV_PCM_TX_RX::can_callback(const common::can_comms_data_msg &recvd_data) {
  cav_out.long_accel = 50;
  cav_out.lcc_steer = 10;
  cav_out.acc_valid = 1;
  cav_out.aeb_valid = 1;
  cav_out.lcc_valid = 1;
  cav_out.acc_fault = 0;
  cav_out.aeb_fault = 0;
  cav_out.lcc_fault = 0;
  cav_out.front_radar_fault = 0;
  cav_out.left_radar_fault = 0;
  cav_out.right_radar_fault = 0;
  cav_out.mobileye_fault = 0;
  cav_out.cav_rolling_counter++;
  cav_out.lat_pv++;
  cav_out.long_pv++;
  cav_out.lat_rc++;
  cav_out.long_rc++;
  ...
  if (cav_out.cav_rolling_counter >= 15) {
    cav_out.cav_rolling_counter = 0;
  }
}
...
int main(int argc, char **argv){
    ...
    while (ros::ok()) {
        ...
        if (test == false) {
          std::cout << "Status of CAN: " << stat << std::endl;
          test = true;
        }
        if (stat == canOK) {
          switch (case_num) {
            case 1:
              ...
              cav_in.pcm_rc1_is_in_range =
                  emc_pcm_cav_interface_pcm_to_cav_1_pcm_to_cav1_rc_is_in_range(pcm1.pcm_to_cav1_rc);

              cav_in.aeb_allowed_decode =
                  emc_pcm_cav_interface_pcm_to_cav_1_pcm_aeb_allowed_decode(pcm1.pcm_aeb_allowed);
              cav_in.aeb_allowed_is_in_range =
                  emc_pcm_cav_interface_pcm_to_cav_1_pcm_aeb_allowed_is_in_range(pcm1.pcm_aeb_allowed);

              cav_in.acc_allowed_decode =
                  emc_pcm_cav_interface_pcm_to_cav_1_pcm_acc_allowed_decode(pcm1.pcm_acc_allowed);
              cav_in.acc_allowed_is_in_range =
                  emc_pcm_cav_interface_pcm_to_cav_1_pcm_acc_allowed_is_in_range(pcm1.pcm_acc_allowed);

              cav_in.lcc_allowed_decode =
                  emc_pcm_cav_interface_pcm_to_cav_1_pcm_lcc_allowed_decode(pcm1.pcm_lcc_allowed);
              ...
              cav_in.hsc_alive_is_in_range =
                  emc_pcm_cav_interface_pcm_to_cav_1_pcm_hsc_alive_is_in_range(pcm1.pcm_hsc_alive);
              ...
              drive_ctrl.aeb_allowed =
                  cav_rx.signals_in_range(cav_in.aeb_allowed_decode, cav_in.aeb_allowed_is_in_range);
              drive_ctrl.acc_allowed =
                  cav_rx.signals_in_range(cav_in.acc_allowed_decode, cav_in.acc_allowed_is_in_range);
              drive_ctrl.lcc_allowed =
                  cav_rx.signals_in_range(cav_in.lcc_allowed_decode, cav_in.lcc_allowed_is_in_range);
            ...
            case 2:
              ...
              cav_in.pcm_rc2_is_in_range =
                  emc_pcm_cav_interface_pcm_to_cav_2_pcm_to_cav2_rc_is_in_range(pcm2.pcm_to_cav2_rc);
            ...
            case 3:
              ...
              cav_in.pcm_rc3_is_in_range =
                  emc_pcm_cav_interface_pcm_to_cav_3_pcm_to_cav3_rc_is_in_range(pcm3.pcm_to_cav3_rc);
