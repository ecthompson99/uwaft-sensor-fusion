      ...
      ros::Time now = ros::Time::now();
        ...
        if ((now.toSec() - mem1.toSec()) > 0.01) {  // 0.1
          ...
          if (stat == canOK) {
            ...
            me_obj.me_status[obj_num] = mobeye_rx.signal_in_range(mobileye_obj.obstacle_status_decode,
                                                                  mobileye_obj.obstacle_status_is_in_range);
          ...
          if (stat == canOK) {
            ...
            me_raw_lane.me_lane_type_L = mobeye_rx.signal_in_range(mobileye_lane.left_lane_type_decode,
                                                                   mobileye_lane.left_lane_type_is_in_range);
            ...
            me_raw_lane.me_lane_curvature_L = mobeye_rx.signal_in_range(mobileye_lane.left_curvature_decode,
                                                                        mobileye_lane.left_curvature_is_in_range);
          ...
          if (stat == canOK) {
            ...
            me_raw_lane.me_lane_heading_angle_L = mobeye_rx.signal_in_range(
                mobileye_lane.left_heading_angle_decode, mobileye_lane.left_heading_angle_is_in_range);
          ...
          if (stat == canOK) {
            ...
            me_raw_lane.me_lane_position_R = mobeye_rx.signal_in_range(mobileye_lane.right_position_decode,
                                                                       mobileye_lane.right_position_is_in_range);
