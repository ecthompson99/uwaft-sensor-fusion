"""Environment State Node of the Sensor Fusion Architecture.
...
from src.v1.config import ObjectState


class EnvironmentState:
    """Library of tracked objects that were filtered from Kalman Filter."""
    history = []
    ...
    def plot_history(self, animate: bool = True, **kwargs):
        """Plots the history of tracked objects for visualziation."""
        ...
        if animate:
            ...
            fig = px.line(df, x='dy', y='dx', color='id', hover_data=['time'],
