%this script graphs range vs time and range rate vs time for both 10 mph
%and 20 mph.


clear all
load('./mat files/range_test2_10mph.mat'); 

a = load('./mat files/range_test3_20mph.mat','relpos_oxts');
relpos_oxts2 = a.relpos_oxts;
a = load('./mat files/range_test3_20mph.mat','sf_clean');
sf_clean2 = a.sf_clean;
a = load('./mat files/range_test3_20mph.mat','max_objects');
max_objects2 = a;
